...
#ifndef SFML3D_SOUNDFILEREADER_HPP
#define SFML3D_SOUNDFILEREADER_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_AUDIO_API SoundFileReader
{
public:
...
#endif // SFML3D_SOUNDFILEREADER_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::SoundFileReader
/// \ingroup audio
///
/// This class allows users to read audio file formats not natively
/// supported by SFML3D, and thus extend the set of supported readable
/// audio formats.
///
...
/// SFML3D to find a suitable writer for a given input file.
///
/// To register a new reader, use the sf3d::SoundFileFactory::registerReader
/// template function.
///
/// Usage example:
/// \code
/// class MySoundFileReader : public sf3d::SoundFileReader
/// {
/// public:
///
///     static bool check(sf3d::InputStream& stream)
///     {
///         // typically, read the first few header bytes and check fields that identify the format
///         // return true if the reader can handle the format
///     }
///
///     virtual bool open(sf3d::InputStream& stream, Info& info)
///     {
...
///     }
///
///     virtual void seek(sf3d::Uint64 sampleOffset)
///     {
///         // advance to the sampleOffset-th sample from the beginning of the sound
///     }
///
///     virtual sf3d::Uint64 read(sf3d::Int16* samples, sf3d::Uint64 maxCount)
///     {
...
/// };
///
/// sf3d::SoundFileFactory::registerReader<MySoundFileReader>();
/// \endcode
///
/// \see sf3d::InputSoundFile, sf3d::SoundFileFactory, sf3d::SoundFileWriter
///
////////////////////////////////////////////////////////////
