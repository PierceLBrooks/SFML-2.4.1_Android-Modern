...
#ifndef SFML3D_SOUND_HPP
#define SFML3D_SOUND_HPP

////////////////////////////////////////////////////////////
// Headers
////////////////////////////////////////////////////////////
#include <SFML3D/Audio/Export.hpp>
#include <SFML3D/Audio/SoundSource.hpp>
...
///
////////////////////////////////////////////////////////////
class SFML3D_AUDIO_API Sound : public SoundSource
{
public:
    ...
    /// thus the sf3d::SoundBuffer instance must remain alive as long
    ...
    /// to use it. It is called by the sf3d::SoundBuffer that
...
/// \ingroup audio
///
/// sf3d::Sound is the class to use to play sounds.
/// It provides:
...
///
/// sf3d::Sound is perfect for playing short sounds that can
/// fit in memory and require no latency, like foot steps or
/// gun shots. For longer sounds, like background musics
/// or long speeches, rather see sf3d::Music (which is based
/// on streaming).
///
/// In order to work, a sound must be given a buffer of audio
/// data to play. Audio data (samples) is stored in sf3d::SoundBuffer,
...
/// \endcode
///
/// \see sf3d::SoundBuffer, sf3d::Music
///
////////////////////////////////////////////////////////////
