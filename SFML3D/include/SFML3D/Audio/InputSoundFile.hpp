...
#ifndef SFML3D_INPUTSOUNDFILE_HPP
#define SFML3D_INPUTSOUNDFILE_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_AUDIO_API InputSoundFile : NonCopyable
{
public:
...
#endif // SFML3D_INPUTSOUNDFILE_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::InputSoundFile
/// \ingroup audio
///
/// This class decodes audio samples from a sound file. It is
/// used internally by higher-level classes such as sf3d::SoundBuffer
/// and sf3d::Music, but can also be useful if you want to process
/// or analyze audio files without playing them, or if you want to
/// implement your own version of sf3d::Music with more specific
/// features.
///
/// Usage example:
/// \code
/// // Open a sound file
/// sf3d::InputSoundFile file;
...
/// \endcode
///
/// \see sf3d::SoundFileReader, sf3d::OutputSoundFile
///
////////////////////////////////////////////////////////////
