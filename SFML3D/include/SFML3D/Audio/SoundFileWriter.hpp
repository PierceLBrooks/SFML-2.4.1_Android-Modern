...
#ifndef SFML3D_SOUNDFILEWRITER_HPP
#define SFML3D_SOUNDFILEWRITER_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_AUDIO_API SoundFileWriter
{
public:
...
#endif // SFML3D_SOUNDFILEWRITER_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::SoundFileWriter
/// \ingroup audio
///
/// This class allows users to write audio file formats not natively
/// supported by SFML3D, and thus extend the set of supported writable
/// audio formats.
///
...
/// SFML3D to find a suitable writer for a given filename.
///
/// To register a new writer, use the sf3d::SoundFileFactory::registerWriter
/// template function.
///
/// Usage example:
/// \code
/// class MySoundFileWriter : public sf3d::SoundFileWriter
/// {
/// public:
///
...
///     }
///
///     virtual void write(const sf3d::Int16* samples, sf3d::Uint64 count)
///     {
...
/// };
///
/// sf3d::SoundFileFactory::registerWriter<MySoundFileWriter>();
/// \endcode
///
/// \see sf3d::OutputSoundFile, sf3d::SoundFileFactory, sf3d::SoundFileReader
///
////////////////////////////////////////////////////////////
