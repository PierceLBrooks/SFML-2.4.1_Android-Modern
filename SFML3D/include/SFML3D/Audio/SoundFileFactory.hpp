...
#ifndef SFML3D_SOUNDFILEFACTORY_HPP
#define SFML3D_SOUNDFILEFACTORY_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_AUDIO_API SoundFileFactory
{
public:
...
#include <SFML3D/Audio/SoundFileFactory.inl>

#endif // SFML3D_SOUNDFILEFACTORY_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::SoundFileFactory
/// \ingroup audio
///
...
/// are wrapped into the higher-level classes sf3d::InputSoundFile and
/// sf3d::OutputSoundFile.
///
/// To register a new reader (writer) use the sf3d::SoundFileFactory::registerReader
...
/// \endcode
///
/// \see sf3d::InputSoundFile, sf3d::OutputSoundFile, sf3d::SoundFileReader, sf3d::SoundFileWriter
///
////////////////////////////////////////////////////////////
