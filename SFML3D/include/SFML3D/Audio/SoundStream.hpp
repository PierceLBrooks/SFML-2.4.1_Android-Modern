...
#ifndef SFML3D_SOUNDSTREAM_HPP
#define SFML3D_SOUNDSTREAM_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_AUDIO_API SoundStream : public SoundSource
{
public:
...
#endif // SFML3D_SOUNDSTREAM_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::SoundStream
/// \ingroup audio
///
/// Unlike audio buffers (see sf3d::SoundBuffer), audio streams
...
///
/// sf3d::SoundStream is a base class that doesn't care about the
/// stream source, which is left to the derived class. SFML3D provides
/// a built-in specialization for big files (see sf3d::Music).
...
/// Usage example:
/// \code
/// class CustomStream : public sf3d::SoundStream
/// {
/// public:
///
