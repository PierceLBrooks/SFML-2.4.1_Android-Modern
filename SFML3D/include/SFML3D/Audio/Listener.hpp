...
#ifndef SFML3D_LISTENER_HPP
#define SFML3D_LISTENER_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_AUDIO_API Listener
{
public:
...
/// are heard. If sf3d::View is the eyes of the user, then sf3d::Listener
/// is his ears (by the way, they are often linked together --
/// same position, orientation, etc.).
///
/// sf3d::Listener is a simple interface, which allows to setup the
/// listener in the 3D audio environment (position, direction and
/// up vector), and to adjust the global volume.
///
/// Because the listener is unique in the scene, sf3d::Listener only
/// contains static functions and doesn't have to be instantiated.
///
/// Usage example:
/// \code
/// // Move the listener to the position (1, 0, -5)
/// sf3d::Listener::setPosition(1, 0, -5);
///
/// // Make it face the right axis (1, 0, 0)
/// sf3d::Listener::setDirection(1, 0, 0);
///
/// // Reduce the global volume
/// sf3d::Listener::setGlobalVolume(50);
/// \endcode
///
////////////////////////////////////////////////////////////
