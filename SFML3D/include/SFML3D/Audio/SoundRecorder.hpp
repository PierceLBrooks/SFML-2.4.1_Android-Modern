...
#ifndef SFML3D_SOUNDRECORDER_HPP
#define SFML3D_SOUNDRECORDER_HPP

////////////////////////////////////////////////////////////
// Headers
////////////////////////////////////////////////////////////
#include <SFML3D/Audio/Export.hpp>
#include <SFML3D/Audio/AlResource.hpp>
...
///
////////////////////////////////////////////////////////////
class SFML3D_AUDIO_API SoundRecorder : AlResource
{
public:
    ...
    /// any attempt to use sf3d::SoundRecorder or one of its derived
    /// classes will fail.
    ///
...
#endif // SFML3D_SOUNDRECORDER_HPP


////////////////////////////////////////////////////////////
/// \class sf3d::SoundRecorder
/// \ingroup audio
///
/// sf3d::SoundBuffer provides a simple interface to access
...
/// SFML3D provides a built-in specialization for saving the
/// captured data to a sound buffer (see sf3d::SoundBufferRecorder).
///
...
/// Usage example:
/// \code
/// class CustomRecorder : public sf3d::SoundRecorder
/// {
///     ~CustomRecorder()
///     {
