...
#ifndef SFML3D_WINDOWHANDLE_HPP
#define SFML3D_WINDOWHANDLE_HPP
...
#endif // SFML3D_WINDOWHANDLE_HPP

////////////////////////////////////////////////////////////
/// \typedef sf3d::WindowHandle
/// \ingroup window
///
...
///
/// On Mac OS X, a sf3d::Window can be created either from an
/// existing \p NSWindow* or an \p NSView*. When the window
/// is created from a window, SFML will use its content view
/// as the OpenGL area. sf3d::Window::getSystemHandle() will
