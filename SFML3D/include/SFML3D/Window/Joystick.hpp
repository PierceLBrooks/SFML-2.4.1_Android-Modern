...
#ifndef SFML3D_JOYSTICK_HPP
#define SFML3D_JOYSTICK_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_WINDOW_API Joystick
{
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    struct SFML3D_WINDOW_API Identification
    {
        Identification();
...
/// \ingroup window
///
/// sf3d::Joystick provides an interface to the state of the
...
/// and JoystickButtonReleased events, sf3d::Joystick can retrieve the
...
///
/// SFML supports:
/// \li 8 joysticks (sf3d::Joystick::Count)
/// \li 32 buttons per joystick (sf3d::Joystick::ButtonCount)
/// \li 8 axes per joystick (sf3d::Joystick::AxisCount)
///
...
/// you must call sf3d::Joystick::update explicitly.
///
/// Usage example:
/// \code
/// // Is joystick #0 connected?
/// bool connected = sf3d::Joystick::isConnected(0);
///
/// // How many buttons does joystick #0 support?
/// unsigned int buttons = sf3d::Joystick::getButtonCount(0);
///
/// // Does joystick #0 define a X axis?
/// bool hasX = sf3d::Joystick::hasAxis(0, sf3d::Joystick::X);
///
/// // Is button #2 pressed on joystick #0?
/// bool pressed = sf3d::Joystick::isButtonPressed(0, 2);
///
/// // What's the current position of the Y axis on joystick #0?
/// float position = sf3d::Joystick::getAxisPosition(0, sf3d::Joystick::Y);
/// \endcode
///
/// \see sf3d::Keyboard, sf3d::Mouse
///
////////////////////////////////////////////////////////////
