...
#ifndef SFML3D_MOUSE_HPP
#define SFML3D_MOUSE_HPP
...
/// \ingroup window
///
/// sf3d::Mouse provides an interface to the state of the
...
/// and MouseButtonReleased events, sf3d::Mouse can retrieve the
...
/// Usage example:
/// \code
/// if (sf3d::Mouse::isButtonPressed(sf3d::Mouse::Left))
/// {
///     // left click...
/// }
///
/// // get global mouse position
/// sf3d::Vector2i position = sf3d::Mouse::getPosition();
///
/// // set mouse position relative to a window
/// sf3d::Mouse::setPosition(sf3d::Vector2i(100, 200), window);
/// \endcode
///
/// \see sf3d::Joystick, sf3d::Keyboard, sf3d::Touch
///
////////////////////////////////////////////////////////////
