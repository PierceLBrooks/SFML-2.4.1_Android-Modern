...
#ifndef SFML3D_TOUCH_HPP
#define SFML3D_TOUCH_HPP
...
/// \ingroup window
///
/// sf3d::Touch provides an interface to the state of the
...
/// and TouchEnded events, sf3d::Touch can retrieve the
...
/// Usage example:
/// \code
/// if (sf3d::Touch::isDown(0))
/// {
///     // touch 0 is down
/// }
///
/// // get global position of touch 1
/// sf3d::Vector2i globalPos = sf3d::Touch::getPosition(1);
///
/// // get position of touch 1 relative to a window
/// sf3d::Vector2i relativePos = sf3d::Touch::getPosition(1, window);
/// \endcode
///
/// \see sf3d::Joystick, sf3d::Keyboard, sf3d::Mouse
///
////////////////////////////////////////////////////////////
