...
#ifndef SFML3D_KEYBOARD_HPP
#define SFML3D_KEYBOARD_HPP
...
///
////////////////////////////////////////////////////////////
class SFML3D_WINDOW_API Keyboard
{
public:
...
/// \ingroup window
///
/// sf3d::Keyboard provides an interface to the state of the
...
/// sf3d::Keyboard can retrieve the state of a key at any time
...
/// Usage example:
/// \code
/// if (sf3d::Keyboard::isKeyPressed(sf3d::Keyboard::Left))
/// {
///     // move left...
/// }
/// else if (sf3d::Keyboard::isKeyPressed(sf3d::Keyboard::Right))
/// {
///     // move right...
/// }
/// else if (sf3d::Keyboard::isKeyPressed(sf3d::Keyboard::Escape))
/// {
///     // quit...
/// }
/// \endcode
///
/// \see sf3d::Joystick, sf3d::Mouse, sf3d::Touch
///
////////////////////////////////////////////////////////////
