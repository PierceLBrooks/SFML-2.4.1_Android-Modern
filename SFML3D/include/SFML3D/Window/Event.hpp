...
#ifndef SFML3D_EVENT_HPP
#define SFML3D_EVENT_HPP
...
/// \ingroup window
///
/// sf3d::Event holds all the informations about a system event
/// that just happened. Events are retrieved using the
/// sf3d::Window::pollEvent and sf3d::Window::waitEvent functions.
///
/// A sf3d::Event instance contains the type of the event
