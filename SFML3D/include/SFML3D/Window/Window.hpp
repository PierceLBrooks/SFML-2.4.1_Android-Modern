...
#ifndef SFML3D_WINDOW_HPP
#define SFML3D_WINDOW_HPP
...
#include <SFML3D/System/Clock.hpp>
...
///
////////////////////////////////////////////////////////////
class SFML3D_WINDOW_API Window : GlResource, NonCopyable
{
public:
    ...
    /// \param style    %Window style, a bitwise OR combination of sf3d::Style enumerators
    ...
    ///
    /// After calling this function, the sf3d::Window instance remains
    ...
    /// but since it internally uses sf3d::sleep, whose precision
    ...
    ///
    /// The type of the returned handle is sf3d::WindowHandle,
...
/// \ingroup window
///
/// sf3d::Window is the main class of the Window module. It defines
/// an OS window that is able to receive an OpenGL rendering.
///
/// A sf3d::Window can create its own new window, or be embedded into
...
///
/// The sf3d::Window class provides a simple interface for manipulating
...
/// OpenGL context attached to the window, with the sf3d::ContextSettings
...
/// sf3d::Window window(sf3d::VideoMode(800, 600), "SFML window");
///
