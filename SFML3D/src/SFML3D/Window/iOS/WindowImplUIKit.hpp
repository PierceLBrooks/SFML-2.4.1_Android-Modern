...
#ifndef SFML3D_WINDOWIMPLUIKIT_HPP
#define SFML3D_WINDOWIMPLUIKIT_HPP
...
#include <SFML3D/Window/iOS/ObjCType.hpp>


SFML3D_DECLARE_OBJC_CLASS(UIWindow);
SFML3D_DECLARE_OBJC_CLASS(SFView);
SFML3D_DECLARE_OBJC_CLASS(SFViewController);
...
#endif // SFML3D_WINDOWIMPLUIKIT_HPP
