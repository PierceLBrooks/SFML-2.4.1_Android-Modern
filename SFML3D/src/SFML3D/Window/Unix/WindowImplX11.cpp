...
// Headers
////////////////////////////////////////////////////////////
#include <SFML3D/Window/WindowStyle.hpp> // important to be included first (conflict with None)
#include <SFML3D/Window/Unix/WindowImplX11.hpp>
#include <SFML3D/Window/Unix/Display.hpp>
#include <SFML3D/Window/Unix/InputImpl.hpp>
#include <SFML3D/System/Utf.hpp>
#include <SFML3D/System/Err.hpp>
#include <SFML3D/System/Mutex.hpp>
#include <SFML3D/System/Lock.hpp>
#include <SFML3D/System/Sleep.hpp>
...
#ifdef SFML3D_OPENGL_ES
    #include <SFML3D/Window/EglContext.hpp>
    typedef sf3d::priv::EglContext ContextType;
#else
    #include <SFML3D/Window/Unix/GlxContext.hpp>
    typedef sf3d::priv::GlxContext ContextType;
#endif
...
namespace
{
    sf3d::priv::WindowImplX11*              fullscreenWindow = NULL;
    std::vector<sf3d::priv::WindowImplX11*> allWindows;
    sf3d::Mutex                             allWindowsMutex;
    sf3d::String                            windowManagerName;
    ...
    bool ewmhSupported()
    {
        ...
        Atom netSupportingWmCheck = sf3d::priv::getAtom("_NET_SUPPORTING_WM_CHECK", true);
        Atom netSupported = sf3d::priv::getAtom("_NET_SUPPORTED", true);

        if (!netSupportingWmCheck || !netSupported)
            return false;

        ::Display* display = sf3d::priv::OpenDisplay();
        ...
        if (result != Success || actualType != XA_WINDOW || numItems != 1)
        {
            ...
            sf3d::priv::CloseDisplay(display);
            return false;
        }
        ...
        Atom netWmName = sf3d::priv::getAtom("_NET_WM_NAME", true);
        ...
        Atom utf8StringType = sf3d::priv::getAtom("UTF8_STRING");
        ...
        if (actualType && numItems)
        {
            ...
            windowManagerName = sf3d::String::fromUtf8(begin, end);
        }
    ...
    sf3d::Keyboard::Key keysymToSF(KeySym symbol)
    {
        switch (symbol)
        {
            case XK_Shift_L:      return sf3d::Keyboard::LShift;
            case XK_Shift_R:      return sf3d::Keyboard::RShift;
            case XK_Control_L:    return sf3d::Keyboard::LControl;
            case XK_Control_R:    return sf3d::Keyboard::RControl;
            case XK_Alt_L:        return sf3d::Keyboard::LAlt;
            case XK_Alt_R:        return sf3d::Keyboard::RAlt;
            case XK_Super_L:      return sf3d::Keyboard::LSystem;
            case XK_Super_R:      return sf3d::Keyboard::RSystem;
            case XK_Menu:         return sf3d::Keyboard::Menu;
            case XK_Escape:       return sf3d::Keyboard::Escape;
            case XK_semicolon:    return sf3d::Keyboard::SemiColon;
            case XK_slash:        return sf3d::Keyboard::Slash;
            case XK_equal:        return sf3d::Keyboard::Equal;
            case XK_minus:        return sf3d::Keyboard::Dash;
            case XK_bracketleft:  return sf3d::Keyboard::LBracket;
            case XK_bracketright: return sf3d::Keyboard::RBracket;
            case XK_comma:        return sf3d::Keyboard::Comma;
            case XK_period:       return sf3d::Keyboard::Period;
            case XK_apostrophe:   return sf3d::Keyboard::Quote;
            case XK_backslash:    return sf3d::Keyboard::BackSlash;
            case XK_grave:        return sf3d::Keyboard::Tilde;
            case XK_space:        return sf3d::Keyboard::Space;
            case XK_Return:       return sf3d::Keyboard::Return;
            case XK_KP_Enter:     return sf3d::Keyboard::Return;
            case XK_BackSpace:    return sf3d::Keyboard::BackSpace;
            case XK_Tab:          return sf3d::Keyboard::Tab;
            case XK_Prior:        return sf3d::Keyboard::PageUp;
            case XK_Next:         return sf3d::Keyboard::PageDown;
            case XK_End:          return sf3d::Keyboard::End;
            case XK_Home:         return sf3d::Keyboard::Home;
            case XK_Insert:       return sf3d::Keyboard::Insert;
            case XK_Delete:       return sf3d::Keyboard::Delete;
            case XK_KP_Add:       return sf3d::Keyboard::Add;
            case XK_KP_Subtract:  return sf3d::Keyboard::Subtract;
            case XK_KP_Multiply:  return sf3d::Keyboard::Multiply;
            case XK_KP_Divide:    return sf3d::Keyboard::Divide;
            case XK_Pause:        return sf3d::Keyboard::Pause;
            case XK_F1:           return sf3d::Keyboard::F1;
            case XK_F2:           return sf3d::Keyboard::F2;
            case XK_F3:           return sf3d::Keyboard::F3;
            case XK_F4:           return sf3d::Keyboard::F4;
            case XK_F5:           return sf3d::Keyboard::F5;
            case XK_F6:           return sf3d::Keyboard::F6;
            case XK_F7:           return sf3d::Keyboard::F7;
            case XK_F8:           return sf3d::Keyboard::F8;
            case XK_F9:           return sf3d::Keyboard::F9;
            case XK_F10:          return sf3d::Keyboard::F10;
            case XK_F11:          return sf3d::Keyboard::F11;
            case XK_F12:          return sf3d::Keyboard::F12;
            case XK_F13:          return sf3d::Keyboard::F13;
            case XK_F14:          return sf3d::Keyboard::F14;
            case XK_F15:          return sf3d::Keyboard::F15;
            case XK_Left:         return sf3d::Keyboard::Left;
            case XK_Right:        return sf3d::Keyboard::Right;
            case XK_Up:           return sf3d::Keyboard::Up;
            case XK_Down:         return sf3d::Keyboard::Down;
            case XK_KP_Insert:    return sf3d::Keyboard::Numpad0;
            case XK_KP_End:       return sf3d::Keyboard::Numpad1;
            case XK_KP_Down:      return sf3d::Keyboard::Numpad2;
            case XK_KP_Page_Down: return sf3d::Keyboard::Numpad3;
            case XK_KP_Left:      return sf3d::Keyboard::Numpad4;
            case XK_KP_Begin:     return sf3d::Keyboard::Numpad5;
            case XK_KP_Right:     return sf3d::Keyboard::Numpad6;
            case XK_KP_Home:      return sf3d::Keyboard::Numpad7;
            case XK_KP_Up:        return sf3d::Keyboard::Numpad8;
            case XK_KP_Page_Up:   return sf3d::Keyboard::Numpad9;
            case XK_a:            return sf3d::Keyboard::A;
            case XK_b:            return sf3d::Keyboard::B;
            case XK_c:            return sf3d::Keyboard::C;
            case XK_d:            return sf3d::Keyboard::D;
            case XK_e:            return sf3d::Keyboard::E;
            case XK_f:            return sf3d::Keyboard::F;
            case XK_g:            return sf3d::Keyboard::G;
            case XK_h:            return sf3d::Keyboard::H;
            case XK_i:            return sf3d::Keyboard::I;
            case XK_j:            return sf3d::Keyboard::J;
            case XK_k:            return sf3d::Keyboard::K;
            case XK_l:            return sf3d::Keyboard::L;
            case XK_m:            return sf3d::Keyboard::M;
            case XK_n:            return sf3d::Keyboard::N;
            case XK_o:            return sf3d::Keyboard::O;
            case XK_p:            return sf3d::Keyboard::P;
            case XK_q:            return sf3d::Keyboard::Q;
            case XK_r:            return sf3d::Keyboard::R;
            case XK_s:            return sf3d::Keyboard::S;
            case XK_t:            return sf3d::Keyboard::T;
            case XK_u:            return sf3d::Keyboard::U;
            case XK_v:            return sf3d::Keyboard::V;
            case XK_w:            return sf3d::Keyboard::W;
            case XK_x:            return sf3d::Keyboard::X;
            case XK_y:            return sf3d::Keyboard::Y;
            case XK_z:            return sf3d::Keyboard::Z;
            case XK_0:            return sf3d::Keyboard::Num0;
            case XK_1:            return sf3d::Keyboard::Num1;
            case XK_2:            return sf3d::Keyboard::Num2;
            case XK_3:            return sf3d::Keyboard::Num3;
            case XK_4:            return sf3d::Keyboard::Num4;
            case XK_5:            return sf3d::Keyboard::Num5;
            case XK_6:            return sf3d::Keyboard::Num6;
            case XK_7:            return sf3d::Keyboard::Num7;
            case XK_8:            return sf3d::Keyboard::Num8;
            case XK_9:            return sf3d::Keyboard::Num9;
        }

        return sf3d::Keyboard::Unknown;
    }
}
...
void WindowImplX11::setMouseCursorGrabbed(bool grabbed)
{
    ...
    if (grabbed)
    {
        ...
        for (unsigned int trial = 0; trial < maxTrialsCount; ++trial)
        {
            ...
            sf3d::sleep(sf3d::milliseconds(50));
        }
...
{
    // Focus is only stolen among SFML3D windows, not between applications
    // Check the global list of windows to find out whether an SFML3D window has the focus
    // Note: can't handle console and other non-SFML3D windows belonging to the application.
    ...
    {
        sf3d::err() << "Failed to check if window is viewable while requesting focus" << std::endl;
    ...
    {
        // Another SFML3D window of this application has the focus and the current window is viewable:
...
bool WindowImplX11::processEvent(XEvent& windowEvent)
{
    ...
    // system's key events policy doesn't match SFML3D's one: X server will generate
    // both repeated KeyPress and KeyRelease events when maintaining a key down, while
    // SFML3D only wants repeated KeyPress events. Thus, we have to:
    ...
    // Convert the X11 event to a sf3d::Event
    switch (windowEvent.type)
    {
        ...
        case KeyPress:
        {
            ...
            for (int i = 0; i < 4; ++i)
            {
                // Get the SFML3D keyboard code from the keysym of the key that has been pressed
        ...
        case KeyRelease:
        {
            ...
            for (int i = 0; i < 4; ++i)
            {
                // Get the SFML3D keyboard code from the keysym of the key that has been released
                key = keysymToSF(XLookupKeysym(&windowEvent.xkey, i));
