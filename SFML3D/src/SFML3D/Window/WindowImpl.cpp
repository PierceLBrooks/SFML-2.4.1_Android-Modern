...
// Headers
////////////////////////////////////////////////////////////
#include <SFML3D/Window/WindowImpl.hpp>
#include <SFML3D/Window/Event.hpp>
#include <SFML3D/Window/JoystickManager.hpp>
#include <SFML3D/Window/SensorManager.hpp>
...
#include <cmath>
    ...
    #include <SFML3D/Window/Win32/WindowImplWin32.hpp>
    typedef sf3d::priv::WindowImplWin32 WindowImplType;

#elif defined(SFML3D_SYSTEM_LINUX) || defined(SFML3D_SYSTEM_FREEBSD)

    #include <SFML3D/Window/Unix/WindowImplX11.hpp>
    typedef sf3d::priv::WindowImplX11 WindowImplType;

#elif defined(SFML3D_SYSTEM_MACOS)

    #include <SFML3D/Window/OSX/WindowImplCocoa.hpp>
    typedef sf3d::priv::WindowImplCocoa WindowImplType;

#elif defined(SFML3D_SYSTEM_IOS)

    #include <SFML3D/Window/iOS/WindowImplUIKit.hpp>
    typedef sf3d::priv::WindowImplUIKit WindowImplType;

#elif defined(SFML3D_SYSTEM_ANDROID)

    #include <SFML3D/Window/Android/WindowImplAndroid.hpp>
    typedef sf3d::priv::WindowImplAndroid WindowImplType;
