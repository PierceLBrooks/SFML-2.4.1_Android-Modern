...
#include <SFML3D/System/ThreadLocalPtr.hpp>
...
#include <cassert>
...
#if !defined(SFML3D_OPENGL_ES)

    #if defined(SFML3D_SYSTEM_WINDOWS)

        #include <SFML3D/Window/Win32/WglContext.hpp>
        typedef sf3d::priv::WglContext ContextType;
        ...
        #include <SFML3D/Window/OSX/SFContext.hpp>
        typedef sf3d::priv::SFContext ContextType;

    #endif

#else

    #if defined(SFML3D_SYSTEM_IOS)

        #include <SFML3D/Window/iOS/EaglContext.hpp>
        typedef sf3d::priv::EaglContext ContextType;
...
namespace
{
    ...
    sf3d::ThreadLocalPtr<sf3d::priv::GlContext> currentContext(NULL);
    ...
    sf3d::ThreadLocalPtr<sf3d::priv::GlContext> currentSharedContext(NULL);
