...
#ifndef SFML3D_WINDOWIMPL_HPP
#define SFML3D_WINDOWIMPL_HPP
...
#include <SFML3D/Window/SensorImpl.hpp>
...
protected:
    ...
    /// notify the SFML3D window that a new event was triggered
    /// by the system.
    ///
