...
namespace
{
    ...
    void updatePluggedList()
    {
        ...
        if (directory)
        {
            ...
            while (directoryEntry && joystickCount < sf3d::Joystick::Count)
            {
    ...
    int usageToAxis(int usage)
    {
        switch (usage)
        {
            case HUG_X:  return sf3d::Joystick::X;
            case HUG_Y:  return sf3d::Joystick::Y;
            case HUG_Z:  return sf3d::Joystick::Z;
            case HUG_RZ: return sf3d::Joystick::R;
            case HUG_RX: return sf3d::Joystick::U;
            case HUG_RY: return sf3d::Joystick::V;
            default:     return -1;
        }
    }

    void hatValueToSfml(int value, sf3d::priv::JoystickState& state)
    {
        state.axes[sf3d::Joystick::PovX] = hatValueMap[value].first;
        state.axes[sf3d::Joystick::PovY] = hatValueMap[value].second;
    }
}
