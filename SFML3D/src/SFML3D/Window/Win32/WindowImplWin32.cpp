...
namespace
{
    ...
    const wchar_t*             className        = L"SFML3D_Window";
    sf3d::priv::WindowImplWin32* fullscreenWindow = NULL;
    ...
    void setProcessDpiAware()
    {
        ...
        if (shCoreDll)
        {
            ...
            if (SetProcessDpiAwarenessFunc)
            {
                ...
                {
                    sf3d::err() << "Failed to set process DPI awareness" << std::endl;
                }
                else
                {
            ...
            if (m_keyRepeatEnabled || ((lParam & (1 << 30)) == 0))
            {
                ...
                else
                {
                    ...
                    if ((character >= 0xDC00) && (character <= 0xDFFF))
                    {
                        ...
                        sf3d::Utf16::toUtf32(utf16, utf16 + 2, &character);
                        m_surrogate = 0;
                    }
