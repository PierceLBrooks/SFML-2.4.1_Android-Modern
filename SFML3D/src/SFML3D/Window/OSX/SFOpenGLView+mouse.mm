...
#import <SFML3D/Window/OSX/SFOpenGLView+mouse_priv.h>
...
{
    sf3d::Mouse::Button button = [SFOpenGLView mouseButtonFromEvent:theEvent];

    if (m_requester != 0)
    {
        NSPoint loc = [self cursorPositionFromEvent:theEvent];

        if (button != sf3d::Mouse::ButtonCount)
...
{
    // Convert the point from SFML3D coord system to screen coord system.
...
-(NSPoint)cursorPositionFromEvent:(NSEvent*)eventOrNil
{
    ...
    // Don't forget to change to SFML3D coord system.
...
////////////////////////////////////////////////////////
+(sf3d::Mouse::Button)mouseButtonFromEvent:(NSEvent*)event
{
    switch ([event buttonNumber])
    {
        case 0:     return sf3d::Mouse::Left;
        case 1:     return sf3d::Mouse::Right;
        case 2:     return sf3d::Mouse::Middle;
        case 3:     return sf3d::Mouse::XButton1;
        case 4:     return sf3d::Mouse::XButton2;
        default:    return sf3d::Mouse::ButtonCount; // Never happens! (hopefully)
    }
}
