...
void processOneModifier(NSUInteger modifiers, NSUInteger mask,
                        BOOL& wasDown, sf3d::Keyboard::Key key,
                        sf3d::priv::WindowImplCocoa& requester);
...
void processLeftRightModifiers(NSUInteger modifiers,
                               ...
                               sf3d::Keyboard::Key leftKey, sf3d::Keyboard::Key rightKey,
                               sf3d::priv::WindowImplCocoa& requester);
...
////////////////////////////////////////////////////////
sf3d::Event::KeyEvent keyEventWithModifiers(NSUInteger modifiers, sf3d::Keyboard::Key key)
{
    sf3d::Event::KeyEvent event;
    event.code    = key;
...
////////////////////////////////////////////////////////
void handleModifiersChanged(NSUInteger modifiers, sf3d::priv::WindowImplCocoa& requester)
{
    // Handle shift
    processLeftRightModifiers(
        ...
        sf3d::Keyboard::LShift, sf3d::Keyboard::RShift,
        requester
    );
    ...
    processLeftRightModifiers(
        ...
        sf3d::Keyboard::LSystem, sf3d::Keyboard::RSystem,
        requester
    );
    ...
    processLeftRightModifiers(
        ...
        sf3d::Keyboard::LAlt, sf3d::Keyboard::RAlt,
        requester
    );
    ...
    processLeftRightModifiers(
        ...
        sf3d::Keyboard::LControl, sf3d::Keyboard::RControl,
        requester
    );
}
                        ...
                        sf3d::priv::WindowImplCocoa& requester)
{
    ...
    sf3d::Event::KeyEvent event = keyEventWithModifiers(modifiers, key);
