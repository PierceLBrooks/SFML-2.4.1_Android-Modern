...
// Headers
////////////////////////////////////////////////////////////
#include <SFML3D/Window/VideoModeImpl.hpp>
...
std::vector<VideoMode> VideoModeImpl::getFullscreenModes()
{
    ...
    if (cgmodes == NULL)
    {
        sf3d::err() << "Couldn't get VideoMode for main display." << std::endl;
        return modes;
    }

    VideoMode desktop = getDesktopMode();

    // Loop on each mode and convert it into a sf3d::VideoMode object.
