...
#import <SFML3D/Window/OSX/cpp_objc_conversion.h>
...
m_showCursor(true)
{
    ...
    else
    {
        ...
        sf3d::err() << "Cannot import this Window Handle because it is neither "
...
WindowImplCocoa::~WindowImplCocoa()
{
    ...
    // This solve some issue when sf3d::Window::Create is called for the
...
void WindowImplCocoa::setUpProcess(void)
{
    ...
    if (!isTheProcessSetAsApplication)
    {
        ...
        // NOTE: This last call won't harm anything even if SFML3D window was
...
{
    sf3d::Vector2i backingPosition = position;
...
{
    sf3d::Vector2u backingSize = size;
