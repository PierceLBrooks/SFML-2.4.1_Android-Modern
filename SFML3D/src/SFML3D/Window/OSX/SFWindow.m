...
-(void)keyDown:(NSEvent*)theEvent
{
    ...
    // that contains a SFML3D rendering area. Doing so will prevent a system
...
-(void)performClose:(id)sender
{
    ...
    //
    // The last paragraph is problematic for SFML3D fullscreen window since they don't have
...
@implementation NSWindow (SFML3D)
