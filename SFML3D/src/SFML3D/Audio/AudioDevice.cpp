...
// Headers
////////////////////////////////////////////////////////////
#include <SFML3D/Audio/AudioDevice.hpp>
...
namespace
{
    ...
    sf3d::Vector3f listenerPosition (0.f, 0.f, 0.f);
    sf3d::Vector3f listenerDirection(0.f, 0.f, -1.f);
    sf3d::Vector3f listenerUpVector (0.f, 1.f, 0.f);
}
