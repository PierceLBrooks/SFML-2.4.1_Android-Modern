...
namespace
{
    ...
    bool decode(sf3d::InputStream& stream, sf3d::Uint8& value)
    {
         return stream.read(&value, sizeof(value)) == sizeof(value);
    }

    bool decode(sf3d::InputStream& stream, sf3d::Int16& value)
    {
    ...
    bool decode(sf3d::InputStream& stream, sf3d::Uint16& value)
    {
        unsigned char bytes[sizeof(value)];
        if (stream.read(bytes, sizeof(bytes)) != sizeof(bytes))
            return false;
    ...
    bool decode24bit(sf3d::InputStream& stream, sf3d::Uint32& value)
    {
    ...
    bool decode(sf3d::InputStream& stream, sf3d::Uint32& value)
    {
        unsigned char bytes[sizeof(value)];
        if (stream.read(bytes, sizeof(bytes)) != sizeof(bytes))
            return false;
    ...
    const sf3d::Uint64 mainChunkSize = 12;
}
