...
#ifndef SFML3D_ALCHECK_HPP
#define SFML3D_ALCHECK_HPP

////////////////////////////////////////////////////////////
// Headers
////////////////////////////////////////////////////////////
#include <SFML3D/Config.hpp>
#ifdef SFML3D_SYSTEM_IOS
    #include <OpenAl/al.h>
...
////////////////////////////////////////////////////////////
    ...
    #define alCheck(expr) do { expr; sf3d::priv::alCheckError(__FILE__, __LINE__, #expr); } while (false)
