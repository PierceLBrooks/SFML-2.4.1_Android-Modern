...
#ifdef SFML3D_SYSTEM_ANDROID

#include <SFML3D/System/Android/Activity.hpp>
#include <SFML3D/System/Sleep.hpp>
#include <SFML3D/System/Thread.hpp>
...
void goToFullscreenMode(ANativeActivity* activity)
{
    ...
    int apiLevel = sf3d::priv::getAndroidApiLevel(activity);
...
static void onResume(ANativeActivity* activity)
{
    ...
    sf3d::priv::ActivityStates* states = sf3d::priv::retrieveStates(activity);
    sf3d::Lock lock(states->mutex);
    ...
    sf3d::Event event;
    event.type = sf3d::Event::MouseEntered;
...
static void onPause(ANativeActivity* activity)
{
    ...
    sf3d::Event event;
    event.type = sf3d::Event::MouseLeft;
...
static void onDestroy(ANativeActivity* activity)
{
    ...
    {
        states->mutex.unlock();
        sf3d::sleep(sf3d::milliseconds(20));
        states->mutex.lock();
    }
    ...
    sf3d::priv::getActivity(NULL, true);
...
static void onNativeWindowCreated(ANativeActivity* activity, ANativeWindow* window)
{
    ...
    {
        states->mutex.unlock();
        sf3d::sleep(sf3d::milliseconds(10));
        states->mutex.lock();
    }
}
...
void ANativeActivity_onCreate(ANativeActivity* activity, void* savedState, size_t savedStateSize)
{
    ...
    sf3d::priv::ActivityStates* states = NULL;
    states = new sf3d::priv::ActivityStates;
    ...
    for (unsigned int i = 0; i < sf3d::Mouse::ButtonCount; i++)
    ...
    sf3d::priv::getActivity(states, true);
    ...
    sf3d::err().rdbuf(&states->logcat);

    // Launch the main thread
    sf3d::Thread* thread = new sf3d::Thread(sf3d::priv::main, states);
    thread->launch();
